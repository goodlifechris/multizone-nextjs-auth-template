...
<div className="bg-red-600 p-4 space-y-2">
    ...
    <a href="/user" className="underline">
      ...
      <div className="relative z-10">
        ...
        <section className="py-24 px-6 text-center">
          ...
          >
            {user ? (
              `Ready to continue your journey? Explore new opportunities or manage your business dashboard.`
            ) : (
            ...
            {user ? (
              <>
                <motion.button 
                  ...
                  className="bg-[#ea580c] text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl shadow-orange-200"
                >
                ...
                <motion.button 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-transparent border-2 border-[#1f2937] px-10 py-5 rounded-2xl font-bold text-lg hover:bg-slate-50"
                >
                  Explore Marketplace
                </motion.button>
              </>
              ...
              <>
                ...
                <motion.button 
                  ...
                  className="bg-transparent border-2 border-[#1f2937] px-10 py-5 rounded-2xl font-bold text-lg"
                >
                  Find Jobs
                </motion.button>
              </>
